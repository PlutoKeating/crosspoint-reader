...
int HomeActivity::getMenuItemCount() const {
  int count = 5;  // Project.Stick, File Browser, Recents, File transfer, Settings
...
void HomeActivity::loop() {
  ...
  auto activateSelection = [this] {
    ...
    switch (indexToMenuItem(menuIndex, hasOpdsServers)) {
      case HomeMenuItem::PROJECT_STICK:
        onProjectStickOpen();
        break;
...
void HomeActivity::render(RenderLock&&) {
  ...
  std::vector<const char*> menuItems = {tr(STR_PROJECT_STICK), tr(STR_BROWSE_FILES), tr(STR_MENU_RECENT_BOOKS),
...
void HomeActivity::onProjectStickOpen() { activityManager.goToProjectStick(); }
